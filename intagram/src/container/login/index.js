        ...
        return (
            <>  
                <ContainerLogin className="px-5 pb-3 mb-2 mx-auto" id="containerLogin">
                    ...
                    <InputCustom type="text" className="form-control" name="" id="" aria-describedby="helpId" placeholder="Số điện thoại, tên người dùng hoặc email" />
                    <InputCustom type="text" className="form-control" name="" id="" aria-describedby="helpId" placeholder="Mật khẩu" />
                    <ButtonCustom type="reset" className="form-control text-white custom-disabled" name="" id="" disabled>
                        {this.state.lblLogin}
                    </ButtonCustom>
                    <WrapperMethod>
                        <LineCustom></LineCustom>
                        <TextCustom id="testCustom">{this.state.or}</TextCustom>
                    </WrapperMethod>
                    <BtnLoginFB>
                        <img src={FBIcon} className="mr-2" width="20" height="20" alt="fb icon" />
                        {this.state.lblLoginFB}
                    </BtnLoginFB>
                    <LblForgot>
                        {this.state.lblForgot}
                    </LblForgot>
                </ContainerLogin>
